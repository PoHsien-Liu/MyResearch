...
在 explanation eval 的主程式（例如 STARE/eval/explanation_eval_main.py）中，支援一個關鍵參數：
...
- 路徑：STARE/configs/top_stocks.py
...
另建 STARE/eval/top_stocks_loader.py，實作：
...
放在 STARE/eval/prompt_template.py：
...
在 STARE/eval/judge_backends.py 中實作：
...
在 STARE/eval/runner.py 中實作兩個主要函式：
...
在 STARE/eval/explanation_eval_main.py 中使用 argparse：
...
python -m STARE.eval.explanation_eval_main \

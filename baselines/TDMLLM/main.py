...
def main():
    ...
    parser.add_argument("--neg_threshold", type=float, default=-0.005, help="DOWN threshold (as return) when using dual_threshold")
    parser.add_argument("--pos_threshold", type=float, default=0.0055, help="UP threshold (as return) when using dual_threshold")

"""Lightweight vLLM wrapper for ZeroShotLLMs AWQ backend."""
...
class VLLMRunner:
    def __init__(self, cfg: VLLMConfig):
        try:
            ...
            raise ImportError("vllm is required for this baseline. Please install vllm in the active environment.") from exc

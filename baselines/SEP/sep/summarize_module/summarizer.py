...
from utils.prompts import SUMMARIZE_INSTRUCTION, MY_SUMMARIZE_INSTRUCTION, ULTRA_SIMPLE_SUMMARIZE_INSTRUCTION
...
class Summarizer:
    def __init__(self, args, method_name="SEP"):
        # 使用超簡單的 prompt 來測試
        self.summarize_prompt = ULTRA_SIMPLE_SUMMARIZE_INSTRUCTION

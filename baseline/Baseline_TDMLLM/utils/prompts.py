...
Generate a short description for stock {ticker}’ s company. Also list general positive and negative factors that might
...
List the top 3 NASDAQ stocks most similar to {ticker} stock.
"""
